...
From this file, use Python regular expressions to extract the two IPv6
addresses.
...
From this, create a list of IPv6 addresses that includes only the above two
addresses.
...
match = re.search(r"IPv6 address:\s+(.*)\s+IPv6 subnet:",
sh_ipv6_int, flags=re.DOTALL)
